    ...
    return (
        <>
            <section className="w-full  mt-[24px]  ">
                <div className="lg:max-w-[948px] xl:max-w-[986px] max-w-[600px]   py-[28px] rounded-2xl bg-[#F9FAFB] px-4 sm:px-[24px]   mx-auto poppins   container ">
                    ...
                    <div className='grid gap-x-4 gap-y-4 lg:grid-cols-3 mt-4'>
                        <div className='lg:border border w-full lg:flex-col gap-x-5 sm:flex-row flex-col flex rounded-[16px] border-[#E5E7EB]   pb-[17.5px]'>
                            <div className='bg-[#F4FEF7]  lg:w-full w-full sm:w-1/2 rounded-[16px] relative !text-[#092061] pt-[34px] px-5 lg:px-[16px] xl:px-[20px] pb-[23.5px]'>
                                ...
                                <p className='font-[400]  mt-[16.5px] text-[18px] poppins text-[#76797C] lg:h-[108px]  text-start'  >Perfect for: Carnival weekends, family emergencies, last-minute getaways</p>
                        ...
                        <div className='lg:border lg:flex-col sm:flex-row flex-col gap-x-5 flex  overflow-hidden rounded-[16px] border-[#E5E7EB] lg:pb-[17.5px] '>
                            ...
                            <div className='  lg:w-full w-full sm:w-1/2   lg:px-[20px]  mx-[7px]'>
                                <div className='flex mt-[8px]  gap-4 items-center'>
                                    <div>
                                        <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M14.5885 5.125L6.56771 13.1458L2.92188 9.5" stroke="#22C55E" stroke-width="1.45833" stroke-linecap="round" stroke-linejoin="round" />
